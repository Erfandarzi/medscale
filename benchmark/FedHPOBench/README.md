...
* FedHPO-Bench is built on a stable [medscale](https://github.com/alibaba/medscale), please see [Installation](https://github.com/alibaba/medscale#step-1-installation) for install medscale.
...
```bash
git clone https://github.com/alibaba/medscale.git
cd medscale/benchmark/FedHPOBench
