...
| pFL-Bench: A Comprehensive Benchmark for Personalized Federated Learning | NeurIPS | [pdf](https://arxiv.org/pdf/2206.03655), [code](https://github.com/alibaba/medscale/tree/master/benchmark/pFL-Bench) | Benchmark | 10+ dataset variants, 20+ methods, fruitful metrics and settings.|
