...
def load_heteroNLP_data(config, client_cfgs):
    ...
    from medscale.nlp.hetero_tasks.dataset.get_data import \
        HeteroNLPDataLoader, SynthDataProcessor
    from medscale.nlp.hetero_tasks.dataloader.datacollator import \
        DataCollator
