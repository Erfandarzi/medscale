...
## Installation
First of all, you need to install medscale, please refer to [installation](https://github.com/alibaba/medscale#step-1-installation).
...
mkdir ABSOLUTE/PATH/TO/medscale/nlp/metric/meteor/data/
mv meteor-1.5/data/paraphrase-en.gz ABSOLUTE/PATH/TO/medscale/nlp/metric/meteor/data/
mv meteor-1.5/meteor-1.5.jar ABSOLUTE/PATH/TO/medscale/nlp/metric/meteor/
```
