...
import torch
import numpy as np
from medscale.attack.privacy_attacks.passive_PIA import \
...
class PassiveServer(Server):
    ...
    def __init__(self,
        ...
        from medscale.attack.auxiliary.utils import get_data_info
