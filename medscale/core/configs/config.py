...
from medscale.core.configs.yacs_config import CfgNode, _merge_a_into_b, \
    Argument
...
from medscale.core.configs import all_sub_configs

for sub_config in all_sub_configs:
    __import__("medscale.core.configs." + sub_config)

from medscale.contrib.configs import all_sub_configs_contrib

for sub_config in all_sub_configs_contrib:
    __import__("medscale.contrib.configs." + sub_config)
