...
from medscale.core.gpu_manager import GPUManager
from medscale.core.auxiliaries.model_builder import get_model
from medscale.core.auxiliaries.utils import get_resource_info
from medscale.core.auxiliaries.feat_engr_builder import \
...
class BaseRunner(object):
    ...
    Args:
        ...
        medscale.core.auxiliaries.data_builder .
    ...
    def _setup_server(self, resource_info=None, client_resource_info=None):
        ...
        if self.cfg.nbafl.use:
            from medscale.core.trainers.trainer_nbafl import \
                wrap_nbafl_server
            wrap_nbafl_server(server)
        if self.cfg.vertical.use:
            from medscale.vertical_fl.utils import wrap_vertical_server
    ...
    def _setup_client(self,
        ...
        if self.cfg.vertical.use:
            from medscale.vertical_fl.utils import wrap_vertical_client
