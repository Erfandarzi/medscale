...
from medscale.core.monitors.early_stopper import EarlyStopper
from medscale.core.message import Message
from medscale.core.communication import StandaloneCommManager, \
    gRPCCommManager
from medscale.core.auxiliaries.aggregator_builder import get_aggregator
from medscale.core.auxiliaries.sampler_builder import get_sampler
from medscale.core.auxiliaries.utils import merge_dict_of_results, \
    Timeout, merge_param_dict
from medscale.core.auxiliaries.trainer_builder import get_trainer
from medscale.core.secret_sharing import AdditiveSecretSharing
from medscale.core.workers.base_server import BaseServer
...
class Server(BaseServer):
    ...
    Attributes:
        ...
        comm_manager: manager for communication, \
            see ``medscale.core.communication``
    """
    def __init__(self,
                 ID=-1,
                 state=0,
