...
from medscale.core.auxiliaries.criterion_builder import get_criterion
from medscale.core.auxiliaries.model_builder import \
    get_trainable_para_names
from medscale.core.auxiliaries.regularizer_builder import get_regularizer
from medscale.core.trainers.enums import MODE
from medscale.core.trainers.utils import calculate_batch_epoch_num
...
class Context(LifecycleDict):
    ...
    Note:
        ...
        [tutorial](https://medscale.io/docs/trainer/).
