...
from medscale.core.auxiliaries.logging import logline_2_wandb_dict
from medscale.core.monitors.metric_calculator import MetricCalculator
...
class Monitor(object):
    ...
    def finish_fed_runner(self, fl_mode=None):
        ...
        if self.use_wandb and not self.wandb_online_track:
            ...
            from medscale.core.auxiliaries.logging import \
    ...
    def calc_model_metric(self, last_model, local_updated_models, rnd):
        ...
        for metric in self.cfg.eval.monitoring:
            ...
            calc_metric = getattr(
                import_module(
                    'medscale.core.monitors.metric_calculator'),
                func_name)
